...
bool LowLevelSolver::isConstraint(int agentID, int x, int y, int time, const std::vector<Constraint2> &constraints) {
	for(Constraint2 c : constraints) {
...
std::vector<std::vector<Cell>> LowLevelSolver::findOptimalPaths(const std::vector<Constraint2> &constraints, const Map &map) {
...
std::vector<Cell> LowLevelSolver::solve(const std::vector<Constraint2> &constraints, const Map &map, int agentID) {
